...
@section('content')
   <div class="">
    ...
    {!! Form::open(['url'=>'receipt/create/penalty','method'=>'POST','class'=>'form-horizontal form-label-left form-wrapper']) !!}
                ...
                <div class="col-md-6">
                  ...
                  <tbody>
                    @foreach($homeOwnerInvoice->invoiceItems as $pendingPayment)
                      @if(strrpos($pendingPayment->item->item_name,'Penalty') || $pendingPayment->item->item_name == 'Penalty')
                        <tr>
